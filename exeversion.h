...
#define __EXEVERSION_H_VERSION__ 2023092921
...
// clang-format off
#define EXE_YEAR          2023                // current year or timespan (e.g. 2003-2009)
#define TEXT_WEBSITE      https:/##/assarbad.net // website
#define TEXT_PRODUCTNAME  RunAsSys                                                                                                 // product's name
#define TEXT_FILEDESC     This uses certain privileges bestowed on members of BUILTIN\\Administrators to gain NT AUTHORITY\\SYSTEM // component description
#define TEXT_COMPANY      Oliver Schneider (assarbad.net)                                                                          // company
#define TEXT_MODULE       runassys                                                                                                 // module name
...
#define TEXT_INTERNALNAME runassys.exe // copyright information
// clang-format on
